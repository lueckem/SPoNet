...
def compute_normal_boundary_reflection(
    ...
    if (reflection <= 0).any():
        ...
        # An upper bound of 1 means, that the whole reflection length of
        # proj_after_breach - state_after_breach is allowed.
        ...
        # If not complete reflection distance is possible, reduce distance slightly.
        # Otherwise, cap upper_bound to 1.
        if upper_bound <= 1:
            upper_bound *= 0.99
        else:
            upper_bound = 1

        reflection = proj_after_breach + upper_bound * reflection_direction
