...
def compute_normal_boundary_reflection(
    ...
    For non balanced rates, an oblique reflection into the (per face) average direction
    ...
    if (reflection <= 0).any():
        ...
        if np.max(proj_after_breach) > 1 - 1 / n_nodes:
            ...
            # Since state_after_breach is on the facette generated by the simplex,
            ...
            # proj_after_breach + a * (proj_after_breach - state_after_breach) >= 0.
            # The upper bound is derived from this condition.
            ...
            # This is done since for balanced rates the mfe reflection pushes outside of corners.
